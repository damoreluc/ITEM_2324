...
char subTopics[maxSubTopic][50]= {thisClient "/pgaSetGain", // subscribed topic di comando del guadagno del PGA
                                  thisClient "/trigger",    // subscried topic di comando della MSF (one-shot, free-run, stop)
                                  thisClient "/inTopic"     // subscribed topic per stampa messaggi
                                  };   
...
char pubTopics[maxPubTopic][50]= {thisClient "/FFTBinTopic0",     // topic di pubblicazione spettro accelerometro 0
                                   thisClient "/FFTBinTopic1",     // topic di pubblicazione spettro accelerometro 1
                                   thisClient "/RTD1BinTopic",     // topic di pubblicazione valore RTD1
                                   thisClient "/RTD1FaultTopic",   // topic di pubblicazione stato RTD1
                                   thisClient "/RTD2BinTopic",     // topic di pubblicazione valore RTD2
                                   thisClient "/RTD2FaultTopic",   // topic di pubblicazione stato RTD2
                                   thisClient "/CountAdcTopic",    // topic di pubblicazione conteggio campioni ADC coppia/velocità
                                   thisClient "/TorqueSpeedTopic", // topic di pubblicazione valori coppia/velocità
                                   thisClient "/pgaGetGain"        // topic di pubblicazione valore attuale del guadagno PGA
                                    };
